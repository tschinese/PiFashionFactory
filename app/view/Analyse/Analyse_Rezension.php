...
Beschreibung: Hier wird der View zur Analyse 'Menge Rezensionen eines Produkts' erstellt
-->

<!--Sprint 4, Kerstin Gräter START-->
<div>
    <h2>Menge der Rezensionen eines Produkts</h2>
<!--    Formular um Produktnummer einzugeben-->
    <form action="index.php?url=AnalyseRezensionController" method="post">
<!--        Sprint 5, Kerstin Gräter START-->
    ...
    <?php
        ...
        $pr = $_POST['produkt'];
	if ($data != null){
            echo '<br><br><font size="+1">Die Anzahl der Rezensionen von '.$pr.' beträgt: <b>'.$data['analyse']['Rezensionen_pro_Produkt'].'</b>';
	}
