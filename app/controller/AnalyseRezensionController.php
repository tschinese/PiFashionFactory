...
//Beschreibung: Controller für Analyse 'Anzahl Rezensionen eines Produkts'

//Sprint 4, Kerstin Gräter START
class AnalyseRezensionController extends Controller{
	...
	function index(){
		...
		$ex = explode(',', $pr);
                $nr = $ex[0];
                $dat1 = $analyse->rezension($nr);
                $dat2 = $auswahl->rezensionauswahl();
