...
//Beschreibung: Controller für Analyse 'Menge Bestellungen eines Produkts'

//Sprint 4, Kerstin Gräter START
class AnalyseMengeController extends Controller{
	...
	function index(){
		...
		$pr = $_POST['produkt'];
                $ex = explode(',', $pr);
                $nr = $ex[0];
                $dat1 = $analyse->menge($nr);
                $dat2 = $auswahl->mengebestellungauswahl();
