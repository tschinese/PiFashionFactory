...
// Tasknummer: 410-3 (#10603) Hersteller hinzufügen und löschen
// Aufwand: 1 Stunde
// Beschreibung: Hier wird das Model zu Hersteller erstellt.
//
...
class Hersteller_Model {
	...
	// function um alle bereits vorhandenen Hersteller aus der Datenbank anzuzeigen
    function anzeigen() {
        // SQL Statement
    ...
    function hinzufuegen($hersteller) {
        // SQL Statement 
        $sql = 'insert into Hersteller (hersteller) values (' . $hersteller . ')';
        ...
        $this->con->schließen();
        // return wert
        return 'Der Hersteller ' . $hersteller . ' wurde hinzugefügt!';
    }

    // function um Farben aus der Datenbank zu löschen
    function loeschen($hersteller) {
        //SQL Statement
        $sql = 'delete from Hersteller where hersteller = ' . $hersteller;
        // Verbindung zur Datenbank
        $this->con = new Connect_Mysql();
        $con = $this->con->verbinden();
        // Ausführung des Statements
        ...
        $this->con->schließen();
        // return wert
        return 'Der Hersteller ' . $hersteller . ' wurde gelöscht!';
    }
